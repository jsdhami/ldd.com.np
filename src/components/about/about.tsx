...
const about = () => {
  return (
    <div className="max-w-4xl mx-auto py-10 px-4">
      <h1 className="text-3xl font-bold mb-6 text-center">About LDD Notes</h1>
      ...
      <p className="text-lg leading-7">
        Feel free to explore the resources and join us in building a better academic support system for students and researchers alike.
      </p>
    </div>
  );
}
